...
cd 
cd bin/build/rohie/
repo init --depth=1 -u https://github.com/RohieOS/manifest -b 11 --depth=1
repo sync -c -q --force-sync --optimized-fetch --no-tags --no-clone-bundle --prune -j$(nproc --all)
echo "********************************************************************************************************************************************************"
cd
cd bin/build/rohie/
git clone https://github.com/Manish4586/android_device_xiaomi_jasmine_sprout.git device/xiaomi/jasmine_sprout 
git clone https://github.com/Manish4586/android_device_xiaomi_sdm660_common.git device/xiaomi/sdm660-common 
git clone https://github.com/Manish4586/android_vendor_xiaomi_jasmine_sprout.git vendor/xiaomi/jasmine_sprout
git clone https://github.com/Manish4586/android_kernel_xiaomi_jasmine_sprout.git kernel/xiaomi/jasmine_sprout 
# git clone https://github.com/OdSazib/vendor_xiaomi_wayne-common.git vendor/xiaomi/wayne-common
echo "********************************************************************************************************************************************************"

cd
#cd bin/build/rohie/device/xiaomi/jasmine_sprout/
